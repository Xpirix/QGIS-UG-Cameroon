help:
	...
	@echo "https://github.com/qgis/QGIS-UG-Cameroon"
	@echo
	@echo "------------------------------------------------------------------"
...
build: ## Build the site for cm.qgis.org
	@echo
	@echo "------------------------------------------------------------------"
...
deploy: ## Deploy the site for cm.qgis.org
	@echo
	@echo "------------------------------------------------------------------"
...
revert-deploy: ## Revert the site for cm.qgis.org
	@echo
	@echo "------------------------------------------------------------------"
